    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('middlename', models.CharField(blank=True, max_length=256, verbose_name='middle name')),
                ('date_of_birth', models.DateField(blank=True, null=True, verbose_name='date of birth')),
                ('profile_picture', versatileimagefield.fields.VersatileImageField(blank=True, null=True, upload_to='user/profile-picture/')),
